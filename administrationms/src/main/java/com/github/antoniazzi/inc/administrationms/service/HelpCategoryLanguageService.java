...
@Service
@Transactional
public class HelpCategoryLanguageService extends EntityServiceImpl<HelpCategoryLanguage, Long, HelpCategoryLanguageRepository> {

	public HelpCategoryLanguageService(HelpCategoryLanguageRepository repository) {
		super(repository);
	}
