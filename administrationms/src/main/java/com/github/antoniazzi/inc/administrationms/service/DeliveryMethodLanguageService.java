...
public class DeliveryMethodLanguageService extends EntityServiceImpl<DeliveryMethodLanguage, Long, DeliveryMethodLanguageRepository> {

	public DeliveryMethodLanguageService(DeliveryMethodLanguageRepository repository) {
		super(repository);
	}
