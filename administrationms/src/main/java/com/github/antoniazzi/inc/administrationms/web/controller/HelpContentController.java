...
import com.github.antoniazzi.inc.administrationms.service.HelpContentService;
...
public class HelpContentController extends EntityController<HelpContent, Long, HelpContentService> {

	public HelpContentController(HelpContentService service) {
		super(service);
	}
